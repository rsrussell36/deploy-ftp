...
|-------------------------|----------|-------------------------------|-------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `server`                | Yes      | `ftp.rsrussell36.com`         |                               | Deployment destination server                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `username`              | Yes      | `username@rsrussell36.com`    |                               | FTP user name                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
This action is a basic wrapper around my `@rsrussell36/ftp-deploy` npm package. To test your config you can install [@rsrussell36/ftp-deploy](https://github.com/rsrussell36/ftp-deploy) and then convert your config to a yml action. Settings are one-to-one, this action is only a wrapper.
...
- Install the npm package using `npm install --dev-only @rsrussell36/ftp-deploy`
